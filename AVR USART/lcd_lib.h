...
//
// Note: This code can be used in 4bit operation and connect LCD pins as    shown below.

// LCD D4,D5,D6,D7 to PD4,PD5,PD6,PD7 and LCD_RS,LCD_RW,LCD_E to PC0,PC1,PC2		
//
//*****************************************************************************
#ifndef LCD_LIB
#define LCD_LIB
